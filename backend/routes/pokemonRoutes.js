...
const { getBattle, newVote, getRankedList, getPokemonByName, updateRanking, getVotesByType, updateTypes, getBattleByType, getBattleByGeneration } = require('../controllers/pokemonController');

const router = express.Router();


router.get('/battle/all', getBattle);
router.get('/battle/gen/:generation', getBattleByGeneration);
